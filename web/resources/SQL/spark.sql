...
LOAD DATA LOCAL INFILE 'C:/SPARK/SPARK_TEST2.CSV' INTO TABLE SPARK FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' (PARKING_CODE,PARKING_NAME,ADDR,PARKING_TYPE,PARKING_TYPE_NM,OPERATION_RULE,OPERATION_RULE_NM,TEL,CAPACITY,CUR_PARKING,PAY_YN,PAY_NM,NIGHT_FREE_OPEN,NIGHT_FREE_OPEN_NM,WEEKDAY_BEGIN_TIME,WEEKDAY_END_TIME,WEEKEND_BEGIN_TIME,WEEKEND_END_TIME,HOLIDAY_BEGIN_TIME,HOLIDAY_END_TIME,SATURDAY_PAY_YN,SATURDAY_PAY_NM,HOLIDAY_PAY_YN,HOLIDAY_PAY_NM,FULLTIME_MONTHLY,RATES,TIME_RATE,ADD_RATES,ADD_TIME_RATE,DAY_MAXIMUM,LAT,LNG);
